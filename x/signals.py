...
class Signal(object):
	...
	def __init__(self, signalnum, **k):
		...
		#
		# I'm not sure why I wanted to make sure these reinitializations
		# were prevented - it seems like there was a good reason when I
		# first wrote this class last year.
		#
